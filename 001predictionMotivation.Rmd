...
*Note:* 5 folds is used mostly to reduce overall processing time while limited gains in accuracy with higher amount; tested at 3 and 10, 5 yielded the highest out of sample error rate (see next section).
...
#stopCluster(cl) # Although suggested to be used, it crahsed RStudio on my Mac.
```
